        ...
        <div className='m-2 bg-gray-200  dark:bg-gray-700 border dark:border-gray-700 rounded-lg'>
            <div className='m-10 flex items-center justify-between'>
                <div className='flex items-center justify-start'>
                    <div>
                        <Button
                            className={'inline-flex w-full justify-center rounded-md px-2 py-2 border border-gray-200 hover:border-gray-300 bg-gray-200 text-black hover:bg-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-500'}
            ...
            <div className='m-10'>
                ...
                <p className='mt-5 whitespace-pre-wrap'>{props.body}</p>
            </div>
            <div></div>
        </div>
    )
